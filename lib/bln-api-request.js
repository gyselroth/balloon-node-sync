...
function getReqOptions(method, endpoint, params) {
  ...
  //TODO: unnecessary with the issue https://github.com/gyselroth/balloon/issues/95
  if (params.sendAsForm === true) {
    delete reqOptions.body;
    delete reqOptions.json;
    delete params.sendAsForm;
    reqOptions.form = params.form;
  }
...
function handleResponse(response, reqOptions, body, callback) {
  ...
  if(response.statusCode < 200 || response.statusCode > 299) {
    ...
    logger.warning('API: ' + errMsg, {category: 'api', body, reqOptions});
